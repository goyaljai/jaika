...
### Server details
```
Base URL:  https://187-127-151-46.sslip.io:5244
...
curl -X POST https://187-127-151-46.sslip.io:5244/api/skills/upload \
...
```javascript
const JAIKA_SERVER = "https://187-127-151-46.sslip.io:5244";
...
- [ ] `JAIKA_SERVER` points to `https://187-127-151-46.sslip.io:5244`
