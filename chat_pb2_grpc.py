...
class JaikaChatStub(object):
    """Bidirectional streaming chat service for Jaika
    Admin-only: allows real-time chat with Gemini via gRPC
    """
...
def add_JaikaChatServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'jaika.JaikaChat', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('jaika.JaikaChat', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class JaikaChat(object):
    """Bidirectional streaming chat service for Jaika
    Admin-only: allows real-time chat with Gemini via gRPC
    """
